 ...
 * @package    org.modelio.module.sysml.gui.explorer
 * @author     Modelio
 ...
 * @author ebrosse
 */
@objid ("315f724b-b0f9-4632-a2ac-46be047ea5ab")
public class ActivityExplorerCommand extends DefaultModuleCommandHandler {
    @objid ("32520552-35c0-427f-a00e-5258d6e7af51")
    @Override
    public void actionPerformed(List<MObject> selectedElements, IModule module) {
        ...
        try( ITransaction transaction = session.createTransaction (I18nMessageService.getString ("Info.Session.Create", "Activity"))){
            for (MObject element : selectedElements) {
                SysMLFactory.createSysMLActivityDiagram((ModelElement)element,"Activity diagram", "");
            }
    ...
    @objid ("a196f2ea-97a2-4738-b3c9-57bbc792cff4")
    @Override
    ...
    @objid ("18c500b3-c9c9-46d6-b4f8-75deb2fca24b")
    @Override
