/**
 * Java Class : AddViewDiagramCommand.java
 *
 * Description :
 *
...
public class ViewDiagramCommand extends DefaultBoxTool {
    ...
    public void actionPerformed(IDiagramHandle representation, IDiagramGraphic target, Rectangle rect) {
        ...
        try( ITransaction transaction = session.createTransaction (I18nMessageService.getString ("Info.Session.Create", "View"))){
            ...
            Package view = SysMLFactory.createView ((NameSpace) element);
            List<IDiagramGraphic> graph = representation.unmask(view, rect.x, rect.y);
