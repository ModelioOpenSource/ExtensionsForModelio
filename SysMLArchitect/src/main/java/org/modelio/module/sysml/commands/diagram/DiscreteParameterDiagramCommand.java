/**
 * Java Class : AddDiscreteParameterDiagramCommand.java
 *
 * Description :
 *
...
public class DiscreteParameterDiagramCommand extends DefaultBoxTool {
    ...
    public void actionPerformed(IDiagramHandle representation, IDiagramGraphic target, Rectangle rect) {
        ...
        try( ITransaction transaction = session.createTransaction (I18nMessageService.getString ("Info.Session.Create", "Discrete Parameter"))){
            MObject element = target.getElement();
            ...
            Parameter parameter = SysMLFactory.createDiscreteParameter(element);
