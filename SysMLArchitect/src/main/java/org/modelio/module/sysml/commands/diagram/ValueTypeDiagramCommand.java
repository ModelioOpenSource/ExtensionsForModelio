/**
 * Java Class : AddValueTypeDiagramCommand.java
 *
 * Description :
 *
...
public class ValueTypeDiagramCommand extends DefaultBoxTool {
    ...
    public void actionPerformed(IDiagramHandle representation, IDiagramGraphic target, Rectangle rect) {
        ...
        try( ITransaction transaction = session.createTransaction (I18nMessageService.getString ("Info.Session.Create", "Value Type"))){
            ...
            MObject type = SysMLFactory.createValueType ((NameSpace) element);
            List<IDiagramGraphic> graph = representation.unmask(type, rect.x, rect.y);
