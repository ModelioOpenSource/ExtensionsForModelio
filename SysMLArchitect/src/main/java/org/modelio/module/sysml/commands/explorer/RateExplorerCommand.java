/**
 * Java Class : AddRateExplorerButton.java
 *
 * Description :
 *
...
public class RateExplorerCommand extends DefaultModuleCommandHandler {
    ...
    public void actionPerformed(List<MObject> selectedElements, IModule module) {
        ...
        try( ITransaction transaction = session.createTransaction (I18nMessageService.getString ("Info.Session.Create", "Rate"))){
        
            for (MObject element : selectedElements) {
                SysMLFactory.createRateParameter (element);
            }
