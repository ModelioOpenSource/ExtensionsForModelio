/**
 * Java Class : AddDiscreteExplorerButton.java
 *
 * Description :
 *
...
public class DiscreteExplorerCommand extends DefaultModuleCommandHandler {
    ...
    public void actionPerformed(List<MObject> selectedElements, IModule module) {
        ...
        try( ITransaction transaction = session.createTransaction (I18nMessageService.getString ("Info.Session.Create", "Discrete"))){
        
            for (MObject element : selectedElements) {
                SysMLFactory.createDiscreteParameter(element);
            }
            transaction.commit ();
        }
    }
