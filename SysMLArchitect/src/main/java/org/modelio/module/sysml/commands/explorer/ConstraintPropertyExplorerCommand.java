/**
 * Java Class : AddConstraintPropertyExplorerButton.java
 *
 * Description :
 *
...
public class ConstraintPropertyExplorerCommand extends DefaultModuleCommandHandler {
    ...
    public void actionPerformed(List<MObject> selectedElements, IModule module) {
        ...
        try( ITransaction transaction = session.createTransaction (I18nMessageService.getString ("Info.Session.Create", "Constraint Property"))){
        
            for (MObject element : selectedElements) {
                SysMLFactory.createConstraintProperty ((NameSpace) element);
            }
    ...
    public boolean accept(List<MObject> selectedElements, IModule module) {
        if (super.accept(selectedElements, module)){
            return (selectedElements.size() > 0) 
                    && CommandExpert.acceptConstraintProperty(selectedElements.get(0));
        }
        return false;
    }
