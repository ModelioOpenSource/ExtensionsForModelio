/**
 * Java Class : AddPropertySpecificTypeExplorerButton.java
 *
 * Description :
 *
...
public class PropertySpecificTypeExplorerCommand extends DefaultModuleCommandHandler {
    ...
    public void actionPerformed(List<MObject> selectedElements, IModule module) {
        ...
        try( ITransaction transaction = session.createTransaction (I18nMessageService.getString ("Info.Session.Create", "Property Specific"))){
        
            for (MObject element : selectedElements) {
                SysMLFactory.createPropertySpecificType((NameSpace) element);
            }
