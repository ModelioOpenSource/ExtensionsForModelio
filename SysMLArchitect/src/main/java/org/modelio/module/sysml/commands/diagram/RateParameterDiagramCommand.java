/**
 * Java Class : AddRateParameterDiagramCommand.java
 *
 * Description :
 *
...
public class RateParameterDiagramCommand extends DefaultBoxTool {
    ...
    public void actionPerformed(IDiagramHandle representation, IDiagramGraphic target, Rectangle rect) {
        ...
        try( ITransaction transaction = session.createTransaction (I18nMessageService.getString ("Info.Session.Create", "Rate Parameter"))){
            MObject element = target.getElement();
            ...
            Parameter parameter = SysMLFactory.createRateParameter( element);
