...
public class InstanceProperty implements IPropertyContent {
	...
	public void changeProperty(ModelElement element, int row, String value) {
		...
		if (row == 2) {
				Stereotype sterType = TogafArchitectModule.getInstance().getModuleContext().getModelingSession().getMetamodelExtensions().getStereotype("TogafArchitect", "TogafApplicationComponentInstance", element.getMClass());
				element.getExtension().add(sterType);
		}
	}
