...
public class TogafInternalActor extends TogafActor {
	...
	public TogafInternalActor() {
		super(TogafArchitectModule.getInstance().getModuleContext().getModelingSession().getModel().createActor());
		ModelUtils.setStereotype(this.element, "TogafArchitect","TogafInternalActor");
		this.element.setName(ResourceManager.getName("TogafInternalActor"));
	}

	public TogafInternalActor(Actor element) {
		super(element);
	}
