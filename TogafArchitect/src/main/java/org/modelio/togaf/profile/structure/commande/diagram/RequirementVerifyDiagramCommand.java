...
public class RequirementVerifyDiagramCommand extends DefaultLinkTool {
	...
	public boolean acceptSecondElement(IDiagramHandle arg0, IDiagramGraphic arg1, IDiagramGraphic arg2) {
		if (arg1.getElement() instanceof ModelElement) {
			...
			if (element.isStereotyped("TogafArchitect","requirement")) {
				return true;
			}
		}
		return false;
