...
public class DeploymentRouter extends HardwareTechnologyComponent {
	...
	public DeploymentRouter() {
		...
		ModelUtils.setStereotype(this.element, "TogafArchitect","DeploymentRouter");
		this.element.setName(ResourceManager.getName("DeploymentRouter"));
	}

	public DeploymentRouter(Node element) {
		super(element);
	}
