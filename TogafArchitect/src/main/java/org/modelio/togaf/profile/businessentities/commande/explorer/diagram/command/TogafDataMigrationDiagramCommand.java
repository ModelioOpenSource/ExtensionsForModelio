...
import org.modelio.togaf.profile.businessentities.model.TogafDataMigrationDiagram;
import org.modelio.togaf.profile.utils.ResourceManager;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TogafDataMigrationDiagramCommand extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
            ...
            TogafDataMigrationDiagram proxy = new TogafDataMigrationDiagram(diagramOwner,style);
    ...
    public String getLabel() {
        return ResourceManager.getName("TogafDataMigrationDiagram");
    }

    public String getInformation() {
        return ResourceManager.getCommandeToolType("TogafDataMigrationDiagram");
    }

    public String getDetails() {
        return org.modelio.togaf.i18n.Messages.getString("TogafDataMigrationDiagram_SHORTNOTE");
    }
}
