...
public class TogafGoalObjectiveServiceDiagramCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafGoalObjectiveServiceDiagram proxy = new TogafGoalObjectiveServiceDiagram(diagramOwner,style);
	...
	public String getLabel() {
		return ResourceManager.getName("TogafGoalObjectiveServiceDiagram");
	}

	public String getInformation() {
		return ResourceManager.getCommandeToolType("TogafGoalObjectiveServiceDiagram");
	}

	public String getDetails() {
		return org.modelio.togaf.i18n.Messages.getString("TogafGoalObjectiveServiceDiagram_SHORTNOTE");
	}
}
