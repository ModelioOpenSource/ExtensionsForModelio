...
public class TogafBusinessCapability extends TogafService {
	...
	public TogafBusinessCapability() {
		...
		ModelUtils.setStereotype(this.element, "TogafArchitect","TogafBusinessCapability");
		this.element.setName(ResourceManager.getName("TogafBusinessCapability"));
		try {
	...
	public TogafBusinessCapability(Interface element) {
		super(element);
	}
