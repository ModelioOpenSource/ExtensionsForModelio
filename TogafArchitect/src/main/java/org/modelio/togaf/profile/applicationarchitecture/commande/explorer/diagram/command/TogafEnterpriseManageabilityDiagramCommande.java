...
import org.modelio.togaf.profile.applicationarchitecture.model.TogafEnterpriseManageabilityDiagram;
import org.modelio.togaf.profile.utils.ResourceManager;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TogafEnterpriseManageabilityDiagramCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafEnterpriseManageabilityDiagram proxy = new TogafEnterpriseManageabilityDiagram(diagramOwner,style);
	...
	public String getLabel() {
		return ResourceManager.getName("TogafEnterpriseManageabilityDiagram");
	}

	
	public String getInformation() {
		return ResourceManager.getCommandeToolType("TogafEnterpriseManageabilityDiagram");
	}

	public String getDetails() {
		return org.modelio.togaf.i18n.Messages.getString("TogafEnterpriseManageabilityDiagram_SHORTNOTE");
	}
}
