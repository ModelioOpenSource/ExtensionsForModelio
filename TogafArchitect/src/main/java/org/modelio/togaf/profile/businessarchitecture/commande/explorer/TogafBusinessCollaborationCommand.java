...
import org.modelio.togaf.profile.businessarchitecture.model.TogafBusinessCollaboration;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TogafBusinessCollaborationCommand extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafBusinessCollaboration proxy = new TogafBusinessCollaboration();
