...
public class TogafProcessingDiagramWizardContributor extends TogafDiagramWizardContributor {
    @Override
    ...
    public ElementDescriptor getCreatedElementType() {
        ...
        Stereotype stereotype = extensions.getStereotype(ITogafArchitectPeerModule.MODULE_NAME, "TogafProcessingDiagram", mClass);
