...
public class Responsible {
	...
	public Responsible() {
		...
		ModelUtils.setStereotype(this.element, "TogafArchitect","Responsible");
		// element.setName(ResourceManager.getName("Responsible"));
		this.element.setName("");
	}

	public Responsible(Dependency element) {
	...
	public TogafOrganizationUnit getTogafOrganizationUnit() {
		return new TogafOrganizationUnit((Package) this.element.getDependsOn());
	}
