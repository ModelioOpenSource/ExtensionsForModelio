...
import org.modelio.togaf.profile.technologyarchitecture.model.TechnologyArtifact;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TechnologyArtifactCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			TechnologyArtifact proxy = new TechnologyArtifact();
