...
public class TogafUseCaseDiagramWizardContributor extends TogafDiagramWizardContributor {
    @Override
    public AbstractDiagram actionPerformed(ModelElement diagramOwner, String diagramName, String diagramDescription) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
            ...
            TogafUseCaseDiagram proxy = new TogafUseCaseDiagram(diagramOwner, ITogafArchitectPeerModule.MODULE_NAME, "TogafUseCaseDiagram", style);
    ...
    public ElementDescriptor getCreatedElementType() {
        ...
        Stereotype stereotype = extensions.getStereotype(ITogafArchitectPeerModule.MODULE_NAME, "TogafUseCaseDiagram", mClass);
