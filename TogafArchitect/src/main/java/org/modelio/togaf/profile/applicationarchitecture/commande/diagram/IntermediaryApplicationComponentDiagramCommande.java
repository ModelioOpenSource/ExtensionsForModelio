...
import org.modelio.togaf.profile.applicationarchitecture.model.IntermediaryApplicationComponent;
import org.modelio.togaf.properties.TogafComponentLevel;

public class IntermediaryApplicationComponentDiagramCommande extends DefaultBoxTool {
	...
	public void actionPerformed(IDiagramHandle representation, IDiagramGraphic graphic, Rectangle rec) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			IntermediaryApplicationComponent proxy = new IntermediaryApplicationComponent();
