...
public class TogafApplication extends SystemApplicationComponent {
	...
	public TogafApplication() {
		super(TogafArchitectModule.getInstance().getModuleContext().getModelingSession().getModel().createComponent());
		ModelUtils.setStereotype(this.element, "TogafArchitect","TogafApplication");
		this.element.setName(ResourceManager.getName("TogafApplication"));
	}

	public TogafApplication(Component element) {
		super(element);
	}
