...
import org.modelio.togaf.profile.businessarchitecture.model.TogafInternalRole;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TogafInternalRoleCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafInternalRole proxy = new TogafInternalRole();
