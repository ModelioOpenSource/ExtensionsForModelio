...
public class LogicalDataModel extends Layer {
	...
	public LogicalDataModel() {
		...
		ModelUtils.setStereotype(this.element, "TogafArchitect","LogicalDataModel");
		this.element.setName(ResourceManager.getName("LogicalDataModel"));
	}

	public LogicalDataModel(Package element) {
		super(element);
	}
