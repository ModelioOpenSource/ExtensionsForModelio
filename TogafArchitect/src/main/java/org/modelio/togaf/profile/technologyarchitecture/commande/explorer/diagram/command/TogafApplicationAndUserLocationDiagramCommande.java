...
public class TogafApplicationAndUserLocationDiagramCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafApplicationAndUserLocationDiagram proxy = new TogafApplicationAndUserLocationDiagram(diagramOwner,style);
	...
	public String getLabel() {
		return ResourceManager.getName("TogafApplicationAndUserLocationDiagram");
	}

	public String getInformation() {
		return ResourceManager.getCommandeToolType("TogafApplicationAndUserLocationDiagram");
	}

	public String getDetails() {
		return org.modelio.togaf.i18n.Messages.getString("TogafApplicationAndUserLocationDiagram_SHORTNOTE");
	}
