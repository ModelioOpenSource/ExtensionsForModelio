...
import org.modelio.togaf.profile.applicationarchitecture.model.UtilityApplicationComponent;
import org.modelio.togaf.properties.TogafComponentLevel;

public class UtilityApplicationComponentDiagramCommande extends DefaultBoxTool {
	...
	public void actionPerformed(IDiagramHandle representation, IDiagramGraphic graphic, Rectangle rec) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			UtilityApplicationComponent proxy = new UtilityApplicationComponent();
