...
import org.modelio.togaf.profile.applicationarchitecture.model.TogafSystemFederation;
import org.modelio.togaf.properties.TogafComponentLevel;

public class TogafSystemFederationDiagramCommande extends DefaultBoxTool {
	...
	public void actionPerformed(IDiagramHandle representation, IDiagramGraphic graphic, Rectangle rec) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafSystemFederation proxy = new TogafSystemFederation();
