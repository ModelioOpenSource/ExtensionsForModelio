...
import org.modelio.togaf.profile.technologyarchitecture.model.TogafProcessingDiagram;
import org.modelio.togaf.profile.utils.ResourceManager;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TogafProcessingDiagramCommande extends DefaultModuleCommandHandler {
		...
		String diagramDescription = getInformation();
		 IModelingSession session = TogafArchitectModule.getInstance().getModuleContext().getModelingSession();
	        ...
	        try (ITransaction transaction = session.createTransaction("");) {
	            ...
	            TogafProcessingDiagram proxy = new TogafProcessingDiagram(diagramOwner,style);
    ...
    public String getLabel() {
        return ResourceManager.getName("TogafProcessingDiagram");
    }

    public String getInformation() {
        return ResourceManager.getCommandeToolType("TogafProcessingDiagram");
    }
