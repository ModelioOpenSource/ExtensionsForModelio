...
import org.modelio.togaf.profile.businessarchitecture.model.TogafServiceContract;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TogafServiceContractCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafServiceContract proxy = new TogafServiceContract();
