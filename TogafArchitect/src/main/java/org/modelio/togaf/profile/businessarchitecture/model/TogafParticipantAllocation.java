...
public class TogafParticipantAllocation {
	protected Dependency element;

	public TogafParticipantAllocation() {
		this.element = TogafArchitectModule.getInstance().getModuleContext().getModelingSession().getModel().createDependency();
		ModelUtils.setStereotype(this.element, "TogafArchitect","TogafParticipantAllocation");
		this.element.setName("");
	}

	public TogafParticipantAllocation(Dependency element) {
