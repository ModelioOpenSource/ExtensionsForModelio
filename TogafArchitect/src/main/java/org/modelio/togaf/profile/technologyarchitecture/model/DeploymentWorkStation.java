...
public class DeploymentWorkStation extends HardwareTechnologyComponent {
	...
	public DeploymentWorkStation() {
		...
		ModelUtils.setStereotype(this.element, "TogafArchitect","DeploymentWorkStation");
		this.element.setName(ResourceManager.getName("DeploymentWorkStation"));
	}

	public DeploymentWorkStation(Node element) {
		super(element);
	}
