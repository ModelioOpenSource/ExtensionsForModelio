...
import org.modelio.togaf.profile.businessentities.model.BusinessOperation;

public class BusinessOperationDiagramCommande extends DefaultBoxTool {
	...
	public void actionPerformed(IDiagramHandle representation, IDiagramGraphic graphic, Rectangle rec) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			BusinessOperation proxy = new BusinessOperation();
