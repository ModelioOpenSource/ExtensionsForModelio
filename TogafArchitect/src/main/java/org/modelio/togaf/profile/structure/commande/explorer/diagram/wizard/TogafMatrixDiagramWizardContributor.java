 ...
 * @version  1.0.00 
 **/
package org.modelio.togaf.profile.structure.commande.explorer.diagram.wizard;
...
import org.modelio.togaf.profile.structure.model.TogafMatrixDiagram;
import org.modelio.togaf.profile.utils.TogafDiagramWizardContributor;
import org.modelio.vcore.smkernel.mapi.MClass;
import org.modelio.vcore.smkernel.mapi.MMetamodel;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TogafMatrixDiagramWizardContributor extends TogafDiagramWizardContributor {

    @Override
    public boolean accept(MObject ielement) {
        return ielement instanceof ModelElement && !(ielement instanceof AbstractDiagram);
    }
    ...
    public AbstractDiagram actionPerformed(ModelElement diagramOwner, String diagramName, String diagramDescription) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
            ...
            TogafMatrixDiagram proxy = new TogafMatrixDiagram(diagramOwner,style);
    ...
    public ElementDescriptor getCreatedElementType() {
        ...
        Stereotype stereotype = extensions.getStereotype(ITogafArchitectPeerModule.MODULE_NAME, "TogafMatrixDiagram", mClass);
