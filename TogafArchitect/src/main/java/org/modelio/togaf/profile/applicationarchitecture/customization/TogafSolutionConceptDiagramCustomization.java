...
public class TogafSolutionConceptDiagramCustomization extends DefaultDiagramCustomizer {
	...
	public void fillPalette(PaletteRoot paletteRoot) {
		...
		systemGroup.setInitialState(PaletteDrawer.INITIAL_STATE_OPEN);
		...
		ServiceGroup.add(toolRegistry.getRegisteredTool("TogafISServiceDiagramCommande"));
		ServiceGroup.add(toolRegistry.getRegisteredTool("TogafServiceContractDiagramCommande"));
		ServiceGroup.add(toolRegistry.getRegisteredTool("TogafISServiceOperationDiagramCommande"));
