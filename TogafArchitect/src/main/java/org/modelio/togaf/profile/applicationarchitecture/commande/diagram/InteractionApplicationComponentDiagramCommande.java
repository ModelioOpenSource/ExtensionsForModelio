...
import org.modelio.togaf.profile.applicationarchitecture.model.InteractionApplicationComponent;
import org.modelio.togaf.properties.TogafComponentLevel;

public class InteractionApplicationComponentDiagramCommande extends DefaultBoxTool {
	@Override
	...
	public void actionPerformed(IDiagramHandle representation, IDiagramGraphic graphic, Rectangle rec) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			InteractionApplicationComponent proxy = new InteractionApplicationComponent();
