...
public class TogafEventDiagramCustomization extends DefaultDiagramCustomizer {
	...
	public void fillPalette(PaletteRoot paletteRoot) {
		...
		final PaletteDrawer ContainerGroup = new PaletteDrawer(Messages.getString("PALETTE_Container"), null);
