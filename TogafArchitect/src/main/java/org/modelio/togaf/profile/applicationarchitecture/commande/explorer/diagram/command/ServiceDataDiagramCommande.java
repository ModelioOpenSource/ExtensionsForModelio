...
public class ServiceDataDiagramCommande extends DefaultModuleCommandHandler {
		...
		String diagramDescription = getInformation();
		  IModelingSession session = TogafArchitectModule.getInstance().getModuleContext().getModelingSession();
	        ...
	        try (ITransaction transaction = session.createTransaction("");) {
	            ...
	            ServiceDataDiagram proxy = new ServiceDataDiagram(diagramOwner,style);
    ...
    public String getLabel() {
        return ResourceManager.getName("ServiceDataDiagram");
    }

    public String getInformation() {
        return ResourceManager.getCommandeToolType("ServiceDataDiagram");
    }
  
    public String getDetails() {
        return org.modelio.togaf.i18n.Messages.getString("ServiceDataDiagram_SHORTNOTE");
    }
