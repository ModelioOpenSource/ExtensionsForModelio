...
public class PreCondition {
	...
	public PreCondition() {
		...
		ModelUtils.setStereotype(this.element, "TogafArchitect","PreCondition");
		this.element.setName(ResourceManager.getName("PreCondition"));
	}

	public PreCondition(Constraint element) {
