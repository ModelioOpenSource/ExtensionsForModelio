...
public class DeploymentServer extends HardwareTechnologyComponent {
	...
	public DeploymentServer() {
		...
		ModelUtils.setStereotype(this.element, "TogafArchitect","DeploymentServer");
		this.element.setName(ResourceManager.getName("DeploymentServer"));
	}

	public DeploymentServer(Node element) {
		super(element);
	}
