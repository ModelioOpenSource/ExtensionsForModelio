...
import org.modelio.togaf.profile.applicationarchitecture.model.ApplicationComponentOperation;

public class ApplicationComponentOperationDiagramCommande extends DefaultBoxTool {
	...
	public void actionPerformed(IDiagramHandle representation, IDiagramGraphic graphic, Rectangle rec) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			ApplicationComponentOperation proxy = new ApplicationComponentOperation();
