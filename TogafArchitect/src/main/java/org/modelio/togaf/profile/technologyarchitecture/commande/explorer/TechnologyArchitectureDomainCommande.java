...
public class TechnologyArchitectureDomainCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			TechnologyArchitectureDomain proxy = new TechnologyArchitectureDomain();
