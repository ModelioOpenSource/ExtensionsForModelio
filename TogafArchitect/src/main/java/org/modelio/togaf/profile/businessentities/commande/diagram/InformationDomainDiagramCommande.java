...
import org.modelio.togaf.profile.businessentities.model.InformationDomain;

public class InformationDomainDiagramCommande extends DefaultBoxTool {
	...
	public void actionPerformed(IDiagramHandle representation, IDiagramGraphic graphic, Rectangle rec) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			InformationDomain proxy = new InformationDomain();
