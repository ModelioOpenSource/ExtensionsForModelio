 ...
 * @version  1.0.00 
 **/
package org.modelio.togaf.profile.technologyarchitecture.commande.explorer.diagram.command;
...
import org.modelio.togaf.profile.technologyarchitecture.model.TogafCommunicationEngineeringDiagrams;
import org.modelio.togaf.profile.utils.ResourceManager;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TogafCommunicationEngineeringDiagramCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafCommunicationEngineeringDiagrams proxy = new TogafCommunicationEngineeringDiagrams(diagramOwner,style);
	...
	public String getLabel() {
		return ResourceManager.getName("TogafCommunicationEngineeringDiagrams");
	}

	public String getInformation() {
		return ResourceManager.getCommandeToolType("TogafCommunicationEngineeringDiagrams");
	}

	public String getDetails() {
		return org.modelio.togaf.i18n.Messages.getString("TogafCommunicationEngineeringDiagrams_SHORTNOTE");
	}
}
