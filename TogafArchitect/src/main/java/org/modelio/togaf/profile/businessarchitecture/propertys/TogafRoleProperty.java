...
public class TogafRoleProperty implements IPropertyContent {
	...
	public void changeProperty(ModelElement element, int row, String value) {
		...
		if (row == 2) {
			...
			ModelUtils.addValue("TogafArchitect","TogafRole_Cardinality", value, element);
		}
	}
	...
	public void update(ModelElement element, IModulePropertyTable table) {
		...
		String value_Cardinality = ModelUtils.getTaggedValue("TogafRole_Cardinality", element);
		if (value_Cardinality.equals("")) {
			value_Cardinality = "";
		}
		table.addProperty(ResourceManager.getPropertyName("TogafRole_Cardinality"), value_Cardinality);
	}
