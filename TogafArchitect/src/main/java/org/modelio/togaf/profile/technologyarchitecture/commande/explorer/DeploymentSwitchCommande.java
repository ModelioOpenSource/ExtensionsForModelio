...
import org.modelio.togaf.profile.technologyarchitecture.model.DeploymentSwitch;
import org.modelio.vcore.smkernel.mapi.MObject;
public class DeploymentSwitchCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			DeploymentSwitch proxy = new DeploymentSwitch();
