...
import org.modelio.togaf.profile.businessarchitecture.model.TogafParticipantAllocation;

public class TogafParticipantAllocationDiagramCommande extends DefaultLinkTool {
	...
	public void actionPerformed(IDiagramHandle representation, IDiagramGraphic graphic_source, IDiagramGraphic graphic_target, LinkRouterKind kind, ILinkRoute path) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafParticipantAllocation proxy = new TogafParticipantAllocation();
