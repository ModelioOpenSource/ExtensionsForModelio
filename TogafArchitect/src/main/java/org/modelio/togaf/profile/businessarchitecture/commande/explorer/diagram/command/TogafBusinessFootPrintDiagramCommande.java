...
import org.modelio.togaf.profile.businessarchitecture.model.TogafBusinessFootPrintDiagram;
import org.modelio.togaf.profile.utils.ResourceManager;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TogafBusinessFootPrintDiagramCommande extends DefaultModuleCommandHandler {
		...
		String diagramDescription = getInformation();
		 IModelingSession session = TogafArchitectModule.getInstance().getModuleContext().getModelingSession();
	        ...
	        try (ITransaction transaction = session.createTransaction("");) {
	            ...
	            TogafBusinessFootPrintDiagram proxy = new TogafBusinessFootPrintDiagram(diagramOwner,style);
    ...
    public String getLabel() {
        return ResourceManager.getName("TogafBusinessFootPrintDiagram");
    }

    
    public String getInformation() {
        return ResourceManager.getCommandeToolType("TogafBusinessFootPrintDiagram");
    }
    
    public String getDetails() {
        return org.modelio.togaf.i18n.Messages.getString("TogafBusinessFootPrintDiagram_SHORTNOTE");
    }
}
