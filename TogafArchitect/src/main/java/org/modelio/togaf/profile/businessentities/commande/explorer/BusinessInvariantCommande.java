...
import org.modelio.togaf.profile.businessentities.model.BusinessInvariant;
import org.modelio.vcore.smkernel.mapi.MObject;

public class BusinessInvariantCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			BusinessInvariant proxy = new BusinessInvariant();
