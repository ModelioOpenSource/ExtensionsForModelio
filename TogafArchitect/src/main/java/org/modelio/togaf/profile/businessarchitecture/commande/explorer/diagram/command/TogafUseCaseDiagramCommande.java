...
import org.modelio.togaf.profile.businessarchitecture.model.TogafUseCaseDiagram;
import org.modelio.togaf.profile.utils.ResourceManager;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TogafUseCaseDiagramCommande extends DefaultModuleCommandHandler {
		...
		String diagramDescription = getInformation();
		 IModelingSession session = TogafArchitectModule.getInstance().getModuleContext().getModelingSession();
	        ...
	        try (ITransaction transaction = session.createTransaction("");) {
	            ...
	            TogafUseCaseDiagram proxy = new TogafUseCaseDiagram(diagramOwner, "TogafArchitect", "TogafUseCaseDiagram",style);
    ...
    public String getLabel() {
        return ResourceManager.getName("TogafUseCaseDiagram");
    }
 
    public String getInformation() {
        return ResourceManager.getCommandeToolType("TogafUseCaseDiagram");
    }

    public String getDetails() {
        return org.modelio.togaf.i18n.Messages.getString("TogafUseCaseDiagram_SHORTNOTE");
    }
