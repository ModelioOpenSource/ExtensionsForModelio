...
public class TogafApplicationMigrationDiagramWizardContributor extends TogafDiagramWizardContributor {
    @Override
    ...
    public ElementDescriptor getCreatedElementType() {
        ...
        Stereotype stereotype = extensions.getStereotype(ITogafArchitectPeerModule.MODULE_NAME, "TogafApplicationMigrationDiagram", mClass);
