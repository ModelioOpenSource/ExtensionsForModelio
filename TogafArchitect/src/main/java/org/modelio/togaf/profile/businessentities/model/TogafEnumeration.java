...
public class TogafEnumeration {
	...
	public TogafEnumeration() {
		...
		ModelUtils.setStereotype(this.element, "TogafArchitect","TogafEnumeration");
		this.element.setName(ResourceManager.getName("TogafEnumeration"));
	}

	public TogafEnumeration(Enumeration element) {
