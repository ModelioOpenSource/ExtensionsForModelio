...
public class SystemApplicationComponentProperty implements IPropertyContent {
    ...
    public void update(ModelElement element, IModulePropertyTable table) {
        ...
        SystemType type = SystemType.getTypeByStereotype(element.getExtension().get(0).getName());
        table.addProperty(ResourceManager.getPropertyName("Property_Type"), type.getName(), SystemType.getTypes());
