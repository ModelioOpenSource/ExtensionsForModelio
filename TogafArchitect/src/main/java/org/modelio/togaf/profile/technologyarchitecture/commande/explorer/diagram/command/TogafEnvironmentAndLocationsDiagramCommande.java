...
public class TogafEnvironmentAndLocationsDiagramCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
            ...
            TogafEnvironmentAndLocationsDiagram proxy = new TogafEnvironmentAndLocationsDiagram(diagramOwner,style);
    ...
    public String getLabel() {
        return ResourceManager.getName("TogafEnvironmentAndLocationsDiagram");
    }

    public String getInformation() {
        return ResourceManager.getCommandeToolType("TogafEnvironmentAndLocationsDiagram");
    }

    public String getDetails() {
        return org.modelio.togaf.i18n.Messages.getString("TogafEnvironmentAndLocationsDiagram_SHORTNOTE");
    }
}
