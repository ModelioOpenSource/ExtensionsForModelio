...
public class Participates {
	...
	public Participates() {
		...
		ModelUtils.setStereotype(this.element, "TogafArchitect","Participates");
		// element.setName(ResourceManager.getName("Participates"));
		this.element.setName("");
	}

	public Participates(Dependency element) {
