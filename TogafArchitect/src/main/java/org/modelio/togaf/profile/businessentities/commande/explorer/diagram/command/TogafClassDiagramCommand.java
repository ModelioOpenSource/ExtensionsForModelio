...
public class TogafClassDiagramCommand extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafClassDiagram proxy = new TogafClassDiagram(diagramOwner,style);
	...
	public String getLabel() {
		return ResourceManager.getName("TogafClassDiagram");
	}

	public String getInformation() {
		return ResourceManager.getCommandeToolType("TogafClassDiagram");
	}

	public String getDetails() {
		return org.modelio.togaf.i18n.Messages.getString("TogafClassDiagram_SHORTNOTE");
	}
