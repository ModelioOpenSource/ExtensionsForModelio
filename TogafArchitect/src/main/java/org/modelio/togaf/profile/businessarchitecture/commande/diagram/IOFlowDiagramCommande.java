...
public class IOFlowDiagramCommande extends DefaultLinkTool {
	...
	public boolean acceptFirstElement(IDiagramHandle representation, IDiagramGraphic graphic) {
		...
		if (owner.isStereotyped("TogafArchitect","BusinessEntities")) {
			return true;
		}
		if (owner.isStereotyped("TogafArchitect","BusinessEntity")) {
			return true;
		}
		...
		if (owner.isStereotyped("TogafArchitect","TogafEvent")) {
			return true;
		}
		...
		if (owner.isStereotyped("TogafArchitect","TogafService")) {
			return true;
		}
		if (owner.isStereotyped("TogafArchitect","TogafProduct")) {
			return true;
		}
