...
public class HeadquarterLocation extends TogafLocation {
	...
	public HeadquarterLocation() {
		super(TogafArchitectModule.getInstance().getModuleContext().getModelingSession().getModel().createNode());
		ModelUtils.setStereotype(this.element, "TogafArchitect","HeadquarterLocation");
		this.element.setName(ResourceManager.getName("HeadquarterLocation"));
	}

	public HeadquarterLocation(Node element) {
		super(element);
	}
