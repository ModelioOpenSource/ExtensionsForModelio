...
public class TogafOrganizationRoleDiagramWizardContributor extends TogafDiagramWizardContributor {
    @Override
    public AbstractDiagram actionPerformed(ModelElement diagramOwner, String diagramName, String diagramDescription) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
            ...
            if (diagramOwner.isStereotyped("TogafArchitect", "OrganizationParticipant")) {
                try (IDiagramHandle rep = moduleContext.getModelioServices().getDiagramService().getDiagramHandle(proxy.getElement())) {
    ...
    public ElementDescriptor getCreatedElementType() {
        ...
        Stereotype stereotype = extensions.getStereotype(ITogafArchitectPeerModule.MODULE_NAME, "TogafOrganizationRoleDiagram", mClass);
