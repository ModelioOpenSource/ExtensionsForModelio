...
public class TogafExternalActor extends TogafActor {
	...
	public TogafExternalActor() {
		super(TogafArchitectModule.getInstance().getModuleContext().getModelingSession().getModel().createActor());
		ModelUtils.setStereotype(this.element, "TogafArchitect","TogafExternalActor");
		this.element.setName(ResourceManager.getName("TogafExternalActor"));
	}

	public TogafExternalActor(Actor element) {
		super(element);
	}
