...
public class TogafSystemFederation extends SystemApplicationComponent {
	...
	public TogafSystemFederation() {
		super(TogafArchitectModule.getInstance().getModuleContext().getModelingSession().getModel().createComponent());
		ModelUtils.setStereotype(this.element, "TogafArchitect","TogafSystemFederation");
		this.element.setName(ResourceManager.getName("TogafSystemFederation"));
	}

	public TogafSystemFederation(Component element) {
		super(element);
	}
