...
public class TogafEventDiagramCommande extends DefaultModuleCommandHandler {
	...
	public String getLabel() {
		return ResourceManager.getName("TogafEventDiagram");
	}

	public String getInformation() {
		return ResourceManager.getCommandeToolType("TogafEventDiagram");
	}

	public String getDetails() {
		return org.modelio.togaf.i18n.Messages.getString("TogafEventDiagram_SHORTNOTE");
	}
