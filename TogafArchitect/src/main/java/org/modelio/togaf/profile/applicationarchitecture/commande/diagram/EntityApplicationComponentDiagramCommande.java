...
import org.modelio.togaf.profile.applicationarchitecture.model.EntityApplicationComponent;
import org.modelio.togaf.properties.TogafComponentLevel;
public class EntityApplicationComponentDiagramCommande extends DefaultBoxTool {
	...
	public void actionPerformed(IDiagramHandle representation, IDiagramGraphic graphic, Rectangle rec) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			EntityApplicationComponent proxy = new EntityApplicationComponent();
