...
public class Assumes {
	...
	public Assumes() {
		...
		ModelUtils.setStereotype(this.element,"TogafArchitect", "Assumes");
		// element.setName(ResourceManager.getName("Assumes"));
		this.element.setName("");
	}

	public Assumes(Dependency element) {
	...
	public TogafActor getTogafActor() {
		return new TogafActor((Actor) this.element.getImpacted());
	}

	public void addTogafActor(TogafActor model) {
		this.element.setImpacted(model.getElement());
	}

	public TogafRole getTogafRole() {
		return new TogafRole((Actor) this.element.getDependsOn());
	}

	public void addTogafRole(TogafRole model) {
