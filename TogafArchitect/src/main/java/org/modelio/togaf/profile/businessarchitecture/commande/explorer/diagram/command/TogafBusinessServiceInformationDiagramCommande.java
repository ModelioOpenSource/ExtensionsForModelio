...
public class TogafBusinessServiceInformationDiagramCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
            ...
            TogafBusinessServiceInformationDiagram proxy = new TogafBusinessServiceInformationDiagram(diagramOwner,style);
    ...
    public String getLabel() {
        return ResourceManager.getName("TogafBusinessServiceInformationDiagram");
    }

    public String getInformation() {
        return ResourceManager.getCommandeToolType("TogafBusinessServiceInformationDiagram");
    }

    public String getDetails() {
        return org.modelio.togaf.i18n.Messages.getString("TogafBusinessServiceInformationDiagram_SHORTNOTE");
    }
