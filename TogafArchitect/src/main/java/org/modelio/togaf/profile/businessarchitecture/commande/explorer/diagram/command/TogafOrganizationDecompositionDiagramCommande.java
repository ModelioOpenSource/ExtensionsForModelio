...
public class TogafOrganizationDecompositionDiagramCommande extends DefaultModuleCommandHandler {
	...
	public String getLabel() {
		return ResourceManager.getName("TogafOrganizationDecompositionDiagram");
	}

	public String getInformation() {
		return ResourceManager.getCommandeToolType("TogafOrganizationDecompositionDiagram");
	}

	public String getDetails() {
		return org.modelio.togaf.i18n.Messages.getString("TogafOrganizationDecompositionDiagram_SHORTNOTE");
	}
}
