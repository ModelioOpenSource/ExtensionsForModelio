...
import org.modelio.togaf.profile.applicationarchitecture.model.SystemApplicationComponent;
import org.modelio.togaf.properties.TogafComponentLevel;

public class SystemApplicationComponentDiagramCommande extends DefaultBoxTool {
	...
	public void actionPerformed(IDiagramHandle representation, IDiagramGraphic graphic, Rectangle rec) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			SystemApplicationComponent proxy = new SystemApplicationComponent();
