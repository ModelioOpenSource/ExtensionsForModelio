...
public class UtilityApplicationComponent extends ServiceApplicationComponent {
	...
	public UtilityApplicationComponent() {
		...
		ModelUtils.setStereotype(this.element,  "TogafArchitect","UtilityApplicationComponent");
		this.element.setName(ResourceManager.getName("UtilityApplicationComponent"));
	}

	public UtilityApplicationComponent(Component element) {
		super(element);
	}
