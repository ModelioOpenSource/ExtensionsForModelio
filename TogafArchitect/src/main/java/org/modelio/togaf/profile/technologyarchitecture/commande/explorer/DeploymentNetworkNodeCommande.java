 ...
 * @version  1.0.00
 **/
package org.modelio.togaf.profile.technologyarchitecture.commande.explorer;
...
import org.modelio.togaf.profile.technologyarchitecture.model.DeploymentNetworkNode;
import org.modelio.vcore.smkernel.mapi.MObject;

public class DeploymentNetworkNodeCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			DeploymentNetworkNode proxy = new DeploymentNetworkNode();
