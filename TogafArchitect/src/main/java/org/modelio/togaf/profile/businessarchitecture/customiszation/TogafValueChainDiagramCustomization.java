...
public class TogafValueChainDiagramCustomization extends DefaultDiagramCustomizer {
	...
	public void fillPalette(PaletteRoot paletteRoot) {
		...
		final PaletteDrawer FunctionGroup = new PaletteDrawer(Messages.getString("PALETTE_Function"), null);
		FunctionGroup.setInitialState(PaletteDrawer.INITIAL_STATE_OPEN);
		FunctionGroup.add(toolRegistry.getRegisteredTool("TogafFunctionDiagramCommande"));
		FunctionGroup.add(toolRegistry.getRegisteredTool("TogafFunctionSequenceDiagramCommande"));
		paletteRoot.add(FunctionGroup);
