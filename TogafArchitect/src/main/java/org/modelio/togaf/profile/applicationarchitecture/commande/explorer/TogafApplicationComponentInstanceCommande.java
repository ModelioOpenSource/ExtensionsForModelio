...
public class TogafApplicationComponentInstanceCommande extends DefaultModuleCommandHandler {
	...
	public boolean accept(List<MObject> selected_element, IModule module) {
		if (selected_element.size() > 0 && selected_element.get(0) instanceof ModelElement) {
			...
			if (element.isStereotyped("TogafArchitect","DeploymentServer")) {
				return true;
			}
			if (element.isStereotyped("TogafArchitect","DeploymentWorkStation")) {
				return true;
			}
