...
public class TogafBusinessFootPrintDiagramCustomization extends DefaultDiagramCustomizer {
	...
	public void fillPalette(PaletteRoot paletteRoot) {
		...
		final PaletteDrawer BusinessGroup = new PaletteDrawer(Messages.getString("PALETTE_BusinessElements"), null);
		BusinessGroup.setInitialState(PaletteDrawer.INITIAL_STATE_OPEN);
		BusinessGroup.add(toolRegistry.getRegisteredTool("TogafFunctionDiagramCommande"));
		BusinessGroup.add(toolRegistry.getRegisteredTool("TogafBusinessServiceDiagramCommande"));
		BusinessGroup.add(toolRegistry.getRegisteredTool("TogafBusinessCapabilityDiagramCommande"));
		paletteRoot.add(BusinessGroup);
