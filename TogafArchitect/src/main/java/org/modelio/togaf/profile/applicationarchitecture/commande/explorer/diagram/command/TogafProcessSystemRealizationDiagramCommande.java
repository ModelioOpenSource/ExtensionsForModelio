...
import org.modelio.togaf.profile.applicationarchitecture.model.TogafProcessSystemRealizationDiagram;
import org.modelio.togaf.profile.utils.ResourceManager;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TogafProcessSystemRealizationDiagramCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafProcessSystemRealizationDiagram proxy = new TogafProcessSystemRealizationDiagram(diagramOwner,style);
	...
	public String getLabel() {
		return ResourceManager.getName("TogafProcessSystemRealizationDiagram");
	}

	public String getInformation() {
		return ResourceManager.getCommandeToolType("TogafProcessSystemRealizationDiagram");
	}

	public String getDetails() {
		return org.modelio.togaf.i18n.Messages.getString("TogafProcessSystemRealizationDiagram_SHORTNOTE");
	}
