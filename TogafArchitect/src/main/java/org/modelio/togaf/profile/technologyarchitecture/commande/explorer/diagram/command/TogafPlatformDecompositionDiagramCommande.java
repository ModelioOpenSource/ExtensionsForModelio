...
public class TogafPlatformDecompositionDiagramCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafPlatformDecompositionDiagram proxy = new TogafPlatformDecompositionDiagram(diagramOwner,style);
	...
	public String getLabel() {
		return ResourceManager.getName("TogafPlatformDecompositionDiagram");
	}

	public String getInformation() {
		return ResourceManager.getCommandeToolType("TogafPlatformDecompositionDiagram");
	}

	public String getDetails() {
		return org.modelio.togaf.i18n.Messages.getString("TogafPlatformDecompositionDiagram_SHORTNOTE");
	}
