...
public class TogafParticipantDecomposition {
	protected Dependency element;

	public TogafParticipantDecomposition() {
		this.element = TogafArchitectModule.getInstance().getModuleContext().getModelingSession().getModel().createDependency();
		ModelUtils.setStereotype(this.element, "TogafArchitect","TogafParticipantDecomposition");
		// element.setName(ResourceManager.getName("TogafParticipantDecomposition"));
		this.element.setName("");
	}

	public TogafParticipantDecomposition(Dependency element) {
