...
public class BusinessOrganizationDomain extends BusinessArchitecture {
	...
	public BusinessOrganizationDomain() {
		...
		ModelUtils.setStereotype(this.element, "TogafArchitect","BusinessOrganizationDomain");
		this.element.setName(ResourceManager.getName("BusinessOrganizationDomain"));
	}

	public BusinessOrganizationDomain(Package element) {
		super(element);
	}
