...
import org.modelio.togaf.profile.applicationarchitecture.model.TogafApplicationMigrationDiagram;
import org.modelio.togaf.profile.utils.ResourceManager;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TogafApplicationMigrationDiagramCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafApplicationMigrationDiagram proxy = new TogafApplicationMigrationDiagram(diagramOwner,style);
	...
	public String getLabel() {
		return ResourceManager.getName("TogafApplicationMigrationDiagram");
	}

	
	public String getInformation() {
		return ResourceManager.getCommandeToolType("TogafApplicationMigrationDiagram");
	}

	public String getDetails() {
		return org.modelio.togaf.i18n.Messages.getString("TogafApplicationMigrationDiagram_SHORTNOTE");
	}
