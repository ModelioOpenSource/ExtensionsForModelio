...
import org.modelio.togaf.profile.applicationarchitecture.model.TogafEnterpriseSystem;
import org.modelio.togaf.properties.TogafComponentLevel;

public class TogafEnterpriseSystemDiagramCommande extends DefaultBoxTool {
	...
	public void actionPerformed(IDiagramHandle representation, IDiagramGraphic graphic, Rectangle rec) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafEnterpriseSystem proxy = new TogafEnterpriseSystem();
