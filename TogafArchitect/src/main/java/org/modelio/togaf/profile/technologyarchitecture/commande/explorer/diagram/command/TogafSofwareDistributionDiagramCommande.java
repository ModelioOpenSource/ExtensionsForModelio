...
import org.modelio.togaf.profile.technologyarchitecture.model.SofwareDistributionDiagram;
import org.modelio.togaf.profile.utils.ResourceManager;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TogafSofwareDistributionDiagramCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
            ...
            SofwareDistributionDiagram proxy = new SofwareDistributionDiagram(diagramOwner,style);
    ...
    public String getLabel() {
        return ResourceManager.getName("SofwareDistributionDiagram");
    }

    public String getInformation() {
        return ResourceManager.getCommandeToolType("SofwareDistributionDiagram");
    }

  
    public String getDetails() {
        return org.modelio.togaf.i18n.Messages.getString("TogafSofwareDistributionDiagram_SHORTNOTE");
    }
}
