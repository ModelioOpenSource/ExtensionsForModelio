...
public class TogafEvent {
	...
	public TogafEvent() {
		...
		ModelUtils.setStereotype(this.element, "TogafArchitect","TogafEvent");
		this.element.setName(ResourceManager.getName("TogafEvent"));
	}

	public TogafEvent(Signal element) {
