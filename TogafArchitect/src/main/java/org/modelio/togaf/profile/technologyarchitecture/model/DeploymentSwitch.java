...
public class DeploymentSwitch extends HardwareTechnologyComponent {
	...
	public DeploymentSwitch() {
		...
		ModelUtils.setStereotype(this.element, "TogafArchitect","DeploymentSwitch");
		this.element.setName(ResourceManager.getName("DeploymentSwitch"));
	}

	public DeploymentSwitch(Node element) {
		super(element);
	}
