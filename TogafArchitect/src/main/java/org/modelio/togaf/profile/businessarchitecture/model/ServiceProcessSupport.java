...
public class ServiceProcessSupport {
	...
	public ServiceProcessSupport() {
		...
		ModelUtils.setStereotype(this.element,"TogafArchitect", "ServiceProcessSupport");
		// element.setName(ResourceManager.getName("ServiceProcessSupport"));
		this.element.setName("");
	}

	public ServiceProcessSupport(Dependency element) {
	...
	public void addtargetTogafService(TogafService model) {
		this.element.setDependsOn(model.getElement());
	}
