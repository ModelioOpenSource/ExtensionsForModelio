...
public class DeploymentNetworkNode extends HardwareTechnologyComponent {
	...
	public DeploymentNetworkNode() {
		super(TogafArchitectModule.getInstance().getModuleContext().getModelingSession().getModel().createNode());
		ModelUtils.setStereotype(this.element,"TogafArchitect", "DeploymentNetworkNode");
		this.element.setName(ResourceManager.getName("DeploymentNetworkNode"));
	}

	public DeploymentNetworkNode(Node element) {
		super(element);
	}
