...
import org.modelio.togaf.profile.businessentities.model.TogafClassHierachyDiagram;
import org.modelio.togaf.profile.utils.ResourceManager;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TogafClassHierachyDiagramCommand extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
            ...
            TogafClassHierachyDiagram proxy = new TogafClassHierachyDiagram(diagramOwner,style);
    ...
    public String getLabel() {
        return ResourceManager.getName("TogafClassHierachyDiagram");
    }

    public String getInformation() {
        return ResourceManager.getCommandeToolType("TogafClassHierachyDiagram");
    }

    public String getDetails() {
        return org.modelio.togaf.i18n.Messages.getString("TogafClassHierachyDiagram_SHORTNOTE");
    }
}
