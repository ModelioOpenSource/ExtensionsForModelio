...
public class TogafSofwareDistributionDiagramWizardContributor extends TogafDiagramWizardContributor {
    @Override
    ...
    public ElementDescriptor getCreatedElementType() {
        ...
        Stereotype stereotype = extensions.getStereotype(ITogafArchitectPeerModule.MODULE_NAME, "SofwareDistributionDiagram", mClass);
