...
import org.modelio.togaf.profile.businessarchitecture.model.Assumes;

public class AssumesDiagramCommande extends DefaultLinkTool {
	...
	public boolean acceptFirstElement(IDiagramHandle representation, IDiagramGraphic graphic) {
		...
		if (owner.isStereotyped("TogafArchitect","TogafActor")) {
			return true;
		}
		return false;
	}
	...
	public boolean acceptSecondElement(IDiagramHandle representation, IDiagramGraphic graphic_source, IDiagramGraphic graphic_target) {
		...
		if (owner.isStereotyped("TogafArchitect","TogafRole")) {
			return true;
		}
		return false;
	}
