...
public class ServiceData {
	...
	public ServiceData() {
		...
		ModelUtils.setStereotype(this.element,"TogafArchitect", "ServiceData");
		this.element.setName(ResourceManager.getName("ServiceData"));
	}

	public ServiceData(Class element) {
