...
public class TogafDataMigrationDiagramCustomization extends DefaultDiagramCustomizer {
	...
	public void fillPalette(PaletteRoot paletteRoot) {
		...
		linkGroup.add(toolRegistry.getRegisteredTool("MigrationDiagramCommand"));
		linkGroup.add(toolRegistry.getRegisteredTool("CREATE_ASSOCIATION"));
		linkGroup.add(toolRegistry.getRegisteredTool("CREATE_AGGREGATION"));
		linkGroup.add(toolRegistry.getRegisteredTool("CREATE_COMPOSITION"));
		linkGroup.add(toolRegistry.getRegisteredTool("CREATE_NARY_ASSOCIATION"));
