...
public class TogafDataSecurityDiagramCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafDataSecurityDiagram proxy = new TogafDataSecurityDiagram(diagramOwner,style);
	...
	public String getLabel() {
		return ResourceManager.getName("TogafDataSecurityDiagram");
	}

	public String getInformation() {
		return ResourceManager.getCommandeToolType("TogafDataSecurityDiagram");
	}

	public String getDetails() {
		return org.modelio.togaf.i18n.Messages.getString("TogafDataSecurityDiagram_SHORTNOTE");
	}
}
