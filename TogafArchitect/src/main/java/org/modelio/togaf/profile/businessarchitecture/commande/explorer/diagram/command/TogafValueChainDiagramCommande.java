...
public class TogafValueChainDiagramCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafValueChainDiagram proxy = new TogafValueChainDiagram(diagramOwner,style);
	...
	public String getLabel() {
		return ResourceManager.getName("TogafValueChainDiagram");
	}

	public String getInformation() {
		return ResourceManager.getCommandeToolType("TogafValueChainDiagram");
	}

	public String getDetails() {
		return org.modelio.togaf.i18n.Messages.getString("TogafValueChainDiagram_SHORTNOTE");
	}
}
