...
import org.modelio.togaf.profile.applicationarchitecture.model.TogafBenefitsDiagram;
import org.modelio.togaf.profile.utils.ResourceManager;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TogafBenefitsDiagramCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafBenefitsDiagram proxy = new TogafBenefitsDiagram(diagramOwner,style);
	...
	public String getLabel() {
		return ResourceManager.getName("TogafBenefitsDiagram");
	}

	public String getInformation() {
		return ResourceManager.getCommandeToolType("TogafBenefitsDiagram");
	}
	
	public String getDetails() {
		return org.modelio.togaf.i18n.Messages.getString("TogafBenefitsDiagram_SHORTNOTE");
	}
