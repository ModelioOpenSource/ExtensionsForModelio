...
public class TogafOrganizationRoleDiagramCommande extends DefaultModuleCommandHandler {
	...
	public boolean accept(List<MObject> selected_element, IModule module) {
		if (selected_element.size() != 0 && selected_element.get(0) instanceof ModelElement) {
			...
			if (element.isStereotyped("TogafArchitect", "OrganizationParticipant")) {
				return true;
			}
		}
		return false;
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafOrganizationRoleDiagram proxy = new TogafOrganizationRoleDiagram(diagramOwner,style);
	...
	public String getLabel() {
		return ResourceManager.getName("TogafOrganizationRoleDiagram");
	}

	public String getInformation() {
		return ResourceManager.getCommandeToolType("TogafOrganizationRoleDiagram");
	}

	public String getDetails() {
		return org.modelio.togaf.i18n.Messages.getString("TogafOrganizationRoleDiagram_SHORTNOTE");
	}
