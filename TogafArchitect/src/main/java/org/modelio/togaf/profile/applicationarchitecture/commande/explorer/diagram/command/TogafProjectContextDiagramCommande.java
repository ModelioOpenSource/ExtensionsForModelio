...
import org.modelio.togaf.profile.applicationarchitecture.model.TogafProjectContextDiagram;
import org.modelio.togaf.profile.utils.ResourceManager;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TogafProjectContextDiagramCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafProjectContextDiagram proxy = new TogafProjectContextDiagram(diagramOwner,style);
	...
	public String getLabel() {
		return ResourceManager.getName("TogafProjectContextDiagram");
	}

	
	public String getInformation() {
		return ResourceManager.getCommandeToolType("TogafProjectContextDiagram");
	}

	public String getDetails() {
		return org.modelio.togaf.i18n.Messages.getString("TogafProjectContextDiagram_SHORTNOTE");
	}
}
