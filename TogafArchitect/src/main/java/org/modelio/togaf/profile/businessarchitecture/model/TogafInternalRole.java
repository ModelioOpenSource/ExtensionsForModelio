...
public class TogafInternalRole extends TogafRole {
	...
	public TogafInternalRole() {
		...
		ModelUtils.setStereotype(this.element, "TogafArchitect","TogafInternalRole");
		this.element.setName(ResourceManager.getName("TogafInternalRole"));
	}

	public TogafInternalRole(Actor element) {
		super(element);
	}
