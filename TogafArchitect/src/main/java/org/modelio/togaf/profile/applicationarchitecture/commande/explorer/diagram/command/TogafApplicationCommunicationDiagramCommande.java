...
public class TogafApplicationCommunicationDiagramCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafApplicationCommunicationDiagram proxy = new TogafApplicationCommunicationDiagram(diagramOwner,style);
	...
	public String getLabel() {
		return ResourceManager.getName("TogafApplicationCommunicationDiagram");
	}

	public String getInformation() {
		return ResourceManager.getCommandeToolType("TogafApplicationCommunicationDiagram");
	}

	public String getDetails() {
		return org.modelio.togaf.i18n.Messages.getString("TogafApplicationCommunicationDiagram_SHORTNOTE");
	}
}
