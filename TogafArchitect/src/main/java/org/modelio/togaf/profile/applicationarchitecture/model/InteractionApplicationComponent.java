...
public class InteractionApplicationComponent extends ServiceApplicationComponent {
	...
	public InteractionApplicationComponent() {
		...
		ModelUtils.setStereotype(this.element, "TogafArchitect","InteractionApplicationComponent");
		this.element.setName(ResourceManager.getName("InteractionApplicationComponent"));
	}

	public InteractionApplicationComponent(Component element) {
		super(element);
	}
