...
public class SoftwareEngineeringDiagramWizardContributor extends TogafDiagramWizardContributor {
	...
	public AbstractDiagram actionPerformed(ModelElement diagramOwner, String diagramName, String diagramDescription) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			AbstractDiagram proxy = model.createClassDiagram("software engineering diagram", lpackage, null);
