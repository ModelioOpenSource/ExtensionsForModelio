...
public class TogafBusinessService extends TogafService {
	...
	public TogafBusinessService() {
		...
		ModelUtils.setStereotype(this.element,"TogafArchitect", "TogafBusinessService");
		this.element.setName(ResourceManager.getName("TogafBusinessService"));
		try {
	...
	public TogafBusinessService(Interface element) {
		super(element);
	}
