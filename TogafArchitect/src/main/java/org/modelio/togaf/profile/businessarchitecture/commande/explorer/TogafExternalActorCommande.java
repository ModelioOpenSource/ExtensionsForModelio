...
import org.modelio.togaf.profile.businessarchitecture.model.TogafExternalActor;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TogafExternalActorCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafExternalActor proxy = new TogafExternalActor();
