...
public class RequirementAssignedDiagramCommand extends DefaultLinkTool {

	@Override
	public boolean acceptFirstElement(IDiagramHandle arg0, IDiagramGraphic arg1) {
		if (arg1.getElement() instanceof Actor || arg1.getElement() instanceof Package || arg1.getElement() instanceof Activity) {
			return true;
		}
		return false;
	}
	...
	public boolean acceptSecondElement(IDiagramHandle arg0, IDiagramGraphic arg1, IDiagramGraphic arg2) {
		if (arg2.getElement() instanceof ModelElement) {
			...
			if (element.isStereotyped("TogafArchitect","goal")) {
				return true;
			}
		}
		return false;
