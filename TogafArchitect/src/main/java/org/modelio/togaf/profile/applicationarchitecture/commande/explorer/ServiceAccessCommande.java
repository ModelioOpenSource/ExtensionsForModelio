...
import org.modelio.togaf.profile.applicationarchitecture.model.ServiceAccess;
import org.modelio.vcore.smkernel.mapi.MObject;

public class ServiceAccessCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			ServiceAccess proxy = new ServiceAccess();
