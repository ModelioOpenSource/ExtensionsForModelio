...
import org.modelio.togaf.profile.applicationarchitecture.model.TogafApplicationCollaboration;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TogafApplicationCollaborationCommand extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafApplicationCollaboration proxy = new TogafApplicationCollaboration();
