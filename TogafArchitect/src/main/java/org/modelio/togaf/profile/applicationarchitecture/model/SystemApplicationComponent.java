...
public class SystemApplicationComponent extends TogafApplicationComponent {
	...
	public SystemApplicationComponent() {
		...
		ModelUtils.setStereotype(this.element, "TogafArchitect","SystemApplicationComponent");
		this.element.setName(ResourceManager.getName("SystemApplicationComponent"));
	}

	public SystemApplicationComponent(Component element) {
		super(element);
	}
