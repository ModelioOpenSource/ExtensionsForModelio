...
public class TogafFunctionalDecompositionDiagramCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
            ...
            TogafFunctionalDecompositionDiagram proxy = new TogafFunctionalDecompositionDiagram(diagramOwner,style);
    ...
    public String getLabel() {
        return ResourceManager.getName("TogafFunctionalDecompositionDiagram");
    }

    
    public String getInformation() {
        return ResourceManager.getCommandeToolType("TogafFunctionalDecompositionDiagram");
    }

    public String getDetails() {
        return org.modelio.togaf.i18n.Messages.getString("TogafFunctionalDecompositionDiagram_SHORTNOTE");
    }
}
