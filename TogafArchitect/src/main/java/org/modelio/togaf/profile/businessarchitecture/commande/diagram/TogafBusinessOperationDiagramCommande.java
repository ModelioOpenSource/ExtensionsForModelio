...
import org.modelio.togaf.profile.businessarchitecture.model.TogafBusinessOperation;

public class TogafBusinessOperationDiagramCommande extends DefaultBoxTool {
	...
	public void actionPerformed(IDiagramHandle representation, IDiagramGraphic graphic, Rectangle rec) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafBusinessOperation proxy = new TogafBusinessOperation();
