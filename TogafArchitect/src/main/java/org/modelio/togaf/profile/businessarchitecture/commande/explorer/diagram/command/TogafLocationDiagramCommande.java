...
import org.modelio.togaf.profile.businessarchitecture.model.TogafLocationDiagram;
import org.modelio.togaf.profile.utils.ResourceManager;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TogafLocationDiagramCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
            ...
            TogafLocationDiagram proxy = new TogafLocationDiagram(diagramOwner,style);
    ...
    public String getLabel() {
        return ResourceManager.getName("TogafLocationDiagram");
    }

   public String getInformation() {
        return ResourceManager.getCommandeToolType("TogafLocationDiagram");
    }

    public String getDetails() {
        return org.modelio.togaf.i18n.Messages.getString("TogafLocationDiagram_SHORTNOTE");
    }
}
