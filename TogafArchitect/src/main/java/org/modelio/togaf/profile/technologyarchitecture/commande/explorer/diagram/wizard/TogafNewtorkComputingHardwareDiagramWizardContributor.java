...
public class TogafNewtorkComputingHardwareDiagramWizardContributor extends TogafDiagramWizardContributor {
    @Override
    ...
    public ElementDescriptor getCreatedElementType() {
        ...
        Stereotype stereotype = extensions.getStereotype(ITogafArchitectPeerModule.MODULE_NAME, "TogafNewtorkComputingHardwareDiagram", mClass);
