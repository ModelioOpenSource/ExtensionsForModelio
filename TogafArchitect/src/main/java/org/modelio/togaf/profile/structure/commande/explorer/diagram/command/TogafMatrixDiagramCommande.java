 ...
 * @version  1.0.00 
 **/
package org.modelio.togaf.profile.structure.commande.explorer.diagram.command;
...
public class TogafMatrixDiagramCommande extends DefaultModuleCommandHandler {
	...
	public String getLabel() {
		return ResourceManager.getName("TogafMatrixDiagram");
	}

	public String getInformation() {
		return ResourceManager.getCommandeToolType("TogafMatrixDiagram");
	}

	public String getDetails() {
		return org.modelio.togaf.i18n.Messages.getString("TogafMatrixDiagram_SHORTNOTE");
	}
