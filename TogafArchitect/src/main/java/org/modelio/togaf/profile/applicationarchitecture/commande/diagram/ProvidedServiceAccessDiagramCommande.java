...
import org.modelio.togaf.profile.applicationarchitecture.model.ProvidedServiceAccess;

public class ProvidedServiceAccessDiagramCommande extends DefaultBoxTool {
	...
	public void actionPerformed(IDiagramHandle representation, IDiagramGraphic graphic, Rectangle rec) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			ProvidedServiceAccess proxy = new ProvidedServiceAccess();
