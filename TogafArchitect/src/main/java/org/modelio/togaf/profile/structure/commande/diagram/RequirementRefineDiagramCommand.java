...
public class RequirementRefineDiagramCommand extends DefaultLinkTool {

	@Override
	public boolean acceptFirstElement(IDiagramHandle arg0, IDiagramGraphic arg1) {
		if (arg1.getElement() instanceof Activity || arg1.getElement() instanceof Operation) {
			return true;
		}

		if (arg1.getElement() instanceof ModelElement) {
			ModelElement element = (ModelElement) arg1.getElement();
