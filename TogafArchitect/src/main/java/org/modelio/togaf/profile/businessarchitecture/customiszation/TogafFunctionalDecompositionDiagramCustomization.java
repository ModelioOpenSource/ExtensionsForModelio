...
public class TogafFunctionalDecompositionDiagramCustomization extends DefaultDiagramCustomizer {
	...
	public void fillPalette(PaletteRoot paletteRoot) {
		...
		LinkGroup.add(toolRegistry.getRegisteredTool("PartDiagramCommande"));
