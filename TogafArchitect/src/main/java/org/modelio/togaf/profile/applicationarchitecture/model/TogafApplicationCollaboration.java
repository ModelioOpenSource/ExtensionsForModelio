...
public class TogafApplicationCollaboration {
	...
	public TogafApplicationCollaboration() {
		this.element = (Collaboration) TogafArchitectModule.getInstance().getModuleContext().getModelingSession().getModel().createElement(TogafArchitectModule.getInstance().getModuleContext().getModelioServices().getMetamodelService().getMetamodel().getMClass(Collaboration.class).getName());
	...
	public TogafApplicationCollaboration(Collaboration element) {
