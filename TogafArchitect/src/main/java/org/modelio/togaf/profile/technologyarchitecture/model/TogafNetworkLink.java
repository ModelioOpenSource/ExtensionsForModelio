...
public class TogafNetworkLink {
	protected Dependency element;

	public TogafNetworkLink() {
		this.element = TogafArchitectModule.getInstance().getModuleContext().getModelingSession().getModel().createDependency();
		ModelUtils.setStereotype(this.element,"TogafArchitect", "NetworkLink");
		this.element.setName("");
	}

	public TogafNetworkLink(Dependency element) {
