...
public class ServiceApplicationComponentProperty implements IPropertyContent {
    ...
    public void changeProperty(ModelElement element, int row, String value) {
        ...
        if (row == 2) {
            ...
            element.getExtension().remove(0);

            Stereotype ster = TogafArchitectModule.getInstance().getModuleContext().getModelingSession().getMetamodelExtensions()
                    .getStereotype("TogafArchitect", ServiceType.getTypeByName(value).getStereotype(), element.getMClass());
    ...
    public void update(ModelElement element, IModulePropertyTable table) {
        ...
        ServiceType type = ServiceType.getTypeByStereotype(element.getExtension().get(0).getName());
        table.addProperty(ResourceManager.getPropertyName("Property_Type"), type.getName(), ServiceType.getTypes());
        ...
        table.addProperty(ResourceManager.getPropertyName("TogafApplicationComponent_TogafApplicationComponent_level"),
                value_TogafApplicationComponent_level, TogafComponentLevel.getValues());
