...
import org.modelio.togaf.profile.businessarchitecture.model.TogafInternalActor;
import org.modelio.vcore.smkernel.mapi.MObject;
public class TogafInternalActorCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
		...
		try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafInternalActor proxy = new TogafInternalActor();
