...
import org.modelio.togaf.profile.technologyarchitecture.model.TogafNewtorkComputingHardwareDiagram;
import org.modelio.togaf.profile.utils.ResourceManager;
import org.modelio.vcore.smkernel.mapi.MObject;

public class TogafNewtorkComputingHardwareDiagramCommande extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selected_element, IModule module) {
        ...
        try (ITransaction transaction = session.createTransaction("");) {
			...
			TogafNewtorkComputingHardwareDiagram proxy = new TogafNewtorkComputingHardwareDiagram(diagramOwner,style);
	...
	public String getLabel() {
		return ResourceManager.getName("TogafNewtorkComputingHardwareDiagram");
	}

	public String getInformation() {
		return ResourceManager.getCommandeToolType("TogafNewtorkComputingHardwareDiagram");
	}

	public String getDetails() {
		return org.modelio.togaf.i18n.Messages.getString("TogafNewtorkComputingHardwareDiagram_SHORTNOTE");
	}
}
