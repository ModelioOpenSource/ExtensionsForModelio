...
public class Communicates {
	...
	public Communicates() {
		...
		ModelUtils.setStereotype(this.element,"TogafArchitect", "Communicates");
		// element.setName(ResourceManager.getName("Communicates"));
		this.element.setName("");
	}

	public Communicates(Dependency element) {
