 ...
 * &lt;element ref="{http://www.modeliosoft.com/rev-modele.xsd}report-item"/>
 * &lt;/sequence>
 * &lt;/restriction>
 * &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "report-list")
public class JaxbReportList implements IVisitorElement {
    
    @XmlElement(name = "report-item")
    protected List<JaxbReportItem> reportItem;
    ...
    public List<JaxbReportItem> getReportItem() {
    ...
    public Object accept(final IReverseModelVisitor visitor) {
        return visitor.visitReportList(this);
    }
